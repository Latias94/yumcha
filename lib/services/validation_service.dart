...
/// 数据验证服务
///
/// 提供统一的数据验证功能，确保应用数据的完整性和有效性。
///
/// 主要功能：
/// - 🤖 **AI 提供商验证**: 验证提供商配置的完整性和有效性
/// - 👤 **AI 助手验证**: 验证助手参数和配置的合理性
/// - 💬 **消息验证**: 验证聊天消息的格式和内容
/// - 🔑 **API 密钥验证**: 验证不同提供商的 API 密钥格式
/// - 🌐 **URL 验证**: 验证 Base URL 和其他 URL 的格式
/// - 📊 **参数验证**: 验证温度、token 数等 AI 参数范围
/// - 🔍 **批量验证**: 支持批量验证多个数据项
/// - ⚙️ **配置完整性**: 验证整体配置的完整性和一致性
///
/// 验证范围：
/// - 数据格式和类型检查
/// - 参数范围和约束验证
