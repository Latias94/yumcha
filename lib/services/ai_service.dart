...
// // - 使用 lib/services/ai/providers/ai_service_provider.dart 中的新Providers
// // - 新架构提供更好的模块化、类型安全和Riverpod集成
// //
// // 推荐替代方案：
// // - 聊天功能: 使用 smartChatProvider 或 sendChatMessageProvider
// // - 模型管理: 使用 providerModelsProvider
// // - 服务初始化: 使用 initializeAiServicesProvider
// import 'dart:async';
// import 'dart:convert';
...
// @Deprecated(
//   '此服务已废弃，请使用 lib/services/ai/ 目录下的新架构。参考 lib/services/ai/MIGRATION_GUIDE.md',
// )
// class AiService {
