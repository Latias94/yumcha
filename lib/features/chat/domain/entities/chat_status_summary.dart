...
class ChatStatusSummary with _$ChatStatusSummary {
  ...
  /// 获取消息统计摘要
  String get messagesSummary => '总计: $totalMessages, 待处理: $pendingMessages, 错误: $errorMessages';
...
class ChatError with _$ChatError {
  ...
  /// 是否为严重错误
  bool get isCritical => type == ChatErrorType.connection || type == ChatErrorType.authentication;
