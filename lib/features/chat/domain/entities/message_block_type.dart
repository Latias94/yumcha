...
extension MessageBlockTypeExtension on MessageBlockType {
  ...
  bool get isMediaType {
    return this == MessageBlockType.image || this == MessageBlockType.file;
  }

  /// 是否是交互类型的块
  bool get isInteractiveType {
    return this == MessageBlockType.tool || this == MessageBlockType.citation;
  }

  /// 是否支持编辑
  bool get isEditable {
    return this == MessageBlockType.mainText || this == MessageBlockType.code;
  }
